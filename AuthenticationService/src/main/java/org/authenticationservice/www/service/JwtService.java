...
//            return keyFactory.generatePrivate(new PKCS8EncodedKeySpec(Base64.getDecoder().decode(configProperties.getPrivateKey())));
//
...
//    }
    ...
    public String newGenerateToken(String kid, PrivateKey privateKey, UserDetails userDetails) {
        Jwt;

        JwtEncoder jwtEncoder = new
    }
}
